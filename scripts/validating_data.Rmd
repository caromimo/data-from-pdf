...
# the GPS coordinates are provided an incomplete (missing negative sign in longitudes) degrees and decimal minutes (DD:MM.MM) format as character strings
...
|>
  mutate(lat_decimal_degrees = ifelse(site_name == "Alder Bay", "50.87247", lat_decimal_degrees)) |>
  mutate(site_number = ifelse(site_name == "Alder Bay", "I", site_number)) |>
  distinct() 
...
BA_data |> write_csv(here("data/interim/broughton_archipelago/broughton_archipelago_all_data.csv"))
```
