...
```{r all BA 2016-2020 data, include=FALSE}
# read the data with little cleaning
BA_2016_data <- read_csv(here("data/interim/broughton_archipelago/all_broughton_archipelago_2016.csv")) |>
  ...
  mutate(
    date_yyyy_mm_dd = as_date(date_of_seine),
...
ppendix_III <- appendix_III %>%
  mutate(
    ...
    reference_nc = "MSB, WJSMP, Broughton Archipelago 2016"
    )


BA_2016_data |>
  add_column(date_YYYY_MM_DD = as_date(date_of_seine), .after = "date_of_seine")
