...
BA_2016_data <- read_csv(here("data/interim/broughton_archipelago/all_broughton_archipelago_2016.csv")) |>
  ...
  add_column(date_iso_8601 = NA, .after = "date_of_seine") |>
  add_column(year = NA, .after = "date_iso_8601") |>
  ...
  mutate(
    date_iso_8601 = dmy(date_of_seine),
    year = year(date_iso_8601),
    month = month(date_iso_8601),
    week = week(date_iso_8601),
