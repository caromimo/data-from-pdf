...
None of the discrepancies in the tables reproduced using data extracted from the 2016 Broughton Archipelago report were due to errors in the extracted data. Additionally, the metadata of the PDF files for 2016, 2017, 2018 and 2019 indicate that all reports were produced using Microsoft® Word 2013 and PDF version. It is therefore reasonable to expect the extraction of data from the 2017, 2018 and 2019 report to behave the same way as for the 2016 report. Consequently, the data extracted from the 2017, 2018 and 2019 do not need to be validated.

### 2020

TBC - is this needed? (maybe given different metadata?)
...
None of the discrepancies in the tables reproduced using data extracted from the 2017 Discovery Islands report were due to errors in the extracted data. Additionally, the metadata of the PDF files for 2017, 2018 and 2019 indicate that all reports were produced using Microsoft® Word 2013 and PDF version. It is therefore reasonable to expect the extraction of data from the 2018 and 2019 report to behave the same way as for the 2017 report. Consequently, the data extracted from the 2018 and 2019 do not need to be validated.To be discussed - do we need this?
...
None of the discrepancies in the tables reproduced using data extracted from the 2016 Quatsino report were due to errors in the extracted data. Additionally, the metadata of the PDF files for 2016, 2017, 2018 and 2019 indicate that all reports were produced using Microsoft® Word 2013 and PDF version. It is therefore reasonable to expect the extraction of data from the 2017, 2018 and 2019 report to behave the same way as for the 2016 report. Consequently, the data extracted from the 2017, 2018 and 2019 do not need to be validated.
...
TBC but should include standardization of the data across years and datasets and collations of all dataset into one dataset (will have to add relevant columns for the reports). Once this is done will we need to revalidate the data? 