...
All datasets within a given region were standardized. All unique sites and their locations were extracted and cleaned using a separate script. This was done for each region. The script can be found in the github repo (creating_master_location_lists.Rmd).
