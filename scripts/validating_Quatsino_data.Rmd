---
title: "Validation of sea lice data extracted from Wild Juvenile Salmonid Monitoring Program Quatsino Sound in British Columbia reports only available as PDF documents"
author: "C. Mimeault"
date: "06/06/2021"
output: pdf_document
---
...
All Wild Juvenile Salmonid Monitoring Program Quatsino Sound, BC documents (PDFs) can normally be found [here](https://mowi.com/caw/sustainability/wild-salmonid-lice-monitoring/) but note that this site is experiencing technical difficulties as I am putting this document together. As of May 2021, reports were available for 2015 to 2020. The 2015 report did not include fish-level sea lice data in the appendix. Data from Appendix III from the 2016 to 2020 reports were extracted using Camelot and csvkit using [this code](https://github.com/caromimo/data-from-pdf/blob/main/Makefile) saved on Github.

To validate the data extraction, some tables included in the report were reproduced. Note that not all sampled fish were collected. Only tables using data related to Appendix III could be reproduced. Both the relevant tables from the reports and the results using extracted data are included in this report. In case of discrepancies, those were explored. 

The Rmarkdown file to generate the present document is available [here](https://github.com/caromimo/data-from-pdf/blob/main/scripts/validating_Quatsino_data.Rmd) on Github.
